...
function normalizeSystemData<
  T extends { sizeBuckets?: unknown; receiptSettings?: unknown; reportSettings?: unknown },
>(data: T): T {
  const out: T = { ...data };
  ...
  if (out.reportSettings === null)
    (out as { reportSettings?: unknown }).reportSettings = Prisma.DbNull;
  return out;
}
